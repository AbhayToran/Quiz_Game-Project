...
public class Quiz extends JFrame implements ActionListener{
    ...
    Quiz(String name,int count){
        ...
        opt1.setFont(new Font("Dialong",Font.PLAIN,20));
        add(opt1);
        
        opt2 = new JRadioButton();
        opt2.setBounds(170,480,700,30);
        opt2.setBackground(Color.WHITE);
        opt2.setFont(new Font("Dialong",Font.PLAIN,20));
        add(opt2);
        
        opt3 = new JRadioButton();
        opt3.setBounds(170,520,700,30);
        opt3.setBackground(Color.WHITE);
        opt3.setFont(new Font("Dialong",Font.PLAIN,20));
        add(opt3);
        
        opt4 = new JRadioButton();
        opt4.setBounds(170,560,700,30);
        opt4.setBackground(Color.WHITE);
        opt4.setFont(new Font("Dialong",Font.PLAIN,20));
        add(opt4);
        ...
        lifeline.setBounds(1000,530,200,40);
